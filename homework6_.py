...
with open("task1.txt", 'r') as f:
    ...
    if count < 3:
        ...
        length = len(data_list_int)
        last_element = data_list_int[len(data_list_int)-1]
        penultimate_element = data_list_int[len(data_list_int)-2]
        print("The first element: ", data_list_int[0])
        print("The second element: ", data_list_int[1])
        print("The penultimate element: ", penultimate_element)
...
#     for el in data_list_int:
#         massiv.append(el ** 2)
#     massiv_str = list(map(str, massiv))
#     str_new = (" ".join(massiv_str))
